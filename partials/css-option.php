...
<?php
    ...
    if(ale_get_option('headerfont')){ echo "<link href='https://fonts.googleapis.com/css?family=".ale_get_option('headerfont').$headerfontex."|".ale_get_option('mainfont').$mainfontex."' rel='stylesheet' type='text/css'>"; }
?>
<style type='text/css'>
    body {
        <?php
