            ...
            <div class="tax_list wrapper">
                <ul>
                    ...
                    foreach($wcatTerms as $wcatTerm) : ?>
                        <li <?php
                            $curr_term = single_term_title("", false);
                            if ( $curr_term == $wcatTerm->name) { echo 'class="active"'; }
                        ?> >
                            <?php if ( $wcatTerm->name == "All") { ?>
                                <a href="<?php echo esc_attr(home_url('/article')); ?>" class="article_category_link">
